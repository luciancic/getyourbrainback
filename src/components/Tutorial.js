...
function Tutorial() {
    return <div className="tutorial">
        ...
        <iframe title="tutorial" width="560" height="315" src="https://www.youtube.com/embed/nOBlJI5w_vI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
